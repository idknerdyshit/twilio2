...
impl<'a> SensitiveAttempt<'a> {
    ...
    fn tracing_for(client: &TwilioClient, options: &RequestOptions) -> bool {
        options
            .sensitive_tracing
    ...
    fn new(
        ...
        let snapshot = (diagnostics.is_some() || sensitive_tracing).then(|| {
...
impl<'a> TwilioAccount<'a> {
    ...
    #[must_use]
    pub fn content(self) -> ContentResource<'a> {
        ContentResource::new(self)
    }
